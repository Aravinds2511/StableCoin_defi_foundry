 ...
 * If a price is stale (3600s), functions will revert, and render the DSCEngine unusable - this is by design.
...
library OracleLib {
    ...
    uint256 private constant TIMEOUT = 3 hours; // hard coded
